    ...
    return (
        <nav className="navbar navbar-expand navbar-dark bg-dark osahan-nav-top p-0">
            <div className="container">
                <Link className="navbar-brand mr-2" to="/"><img src="img/logo_sm.png" alt="" />
                </Link>
                ...
                <ul className="navbar-nav ml-auto d-flex align-items-center">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" onClick={connectWallet}><i className="feather-dollar-sign mr-2"></i><span className="d-none d-lg-inline">Connect Wallet</span></Link>
                    </li>
