...
function GigItem3(props) {
    ...
    const deleteGigNotify = () => toast.success(' Deleted successfully!', {
        position: "top-right",
        theme: 'dark',
        autoClose: 5000,
    ...
    return (
        <div className={props.col}>
            <a className='btn btn-link del-icon-btn small' onClick={deleteGig}><i className="feather-trash-2"></i></a>
